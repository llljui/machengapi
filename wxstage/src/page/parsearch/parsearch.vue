...
export default {
       ...
       if (self.date1&&self.date2) {
          ...
          var params={cid:sessionStorage.cid,channel:sessionStorage.channel,/*sid:'9c8104987b3e7c170121412bb6afd439',toid:'1218482',token:'vk92SYb6349245',*/startTime:Date.parse(self.date1)/1000,endTime:Date.parse(self.date2)/1000}
                    axios.post( sessionStorage.weburl+'/user/team/infoPartner',qs.stringify(params),{headers: {
                           ...
                           self.treward=res.data.data.charge-res.data.data.reward;
  ...
  /*	self.lastp=self.btns.length;*/
     ...
     var params={startTime:self.yesdate,page:'1',cid:sessionStorage.cid,channel:sessionStorage.channel,endTime: self.todaydate}//当天的
     var params2={page:'1',cid:sessionStorage.cid,channel:sessionStorage.channel}//总的
    ...
    axios.post(sessionStorage.weburl+'/user/team/teamPartner',qs.stringify(params2),{headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                      }}).then(function (res) {
     console.log(res);
