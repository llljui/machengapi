<template>
  ...
  <div class="teamrechanger">
    ...
    <el-col :span="10" :offset="1" class="mart">
        <el-date-picker :default-value="yesdate" type="date"  placeholder="选择日期" v-model="date1" @change="transtime(1)" style="width: 100%;"></el-date-picker>
    </el-col>
     <el-col :span="2" class="mart">-</el-col>
    <el-col :span="10" class="mart tablet">
        <el-date-picker :default-value="todaydate" type="date"  placeholder="选择日期"  @change="transtime(2)" v-model="date2" style="width: 100%;"></el-date-picker>
    </el-col>
